...
import 'package:bloc_clean_arch/bloc_clean_arch.dart' as _i4;
import 'package:example/app/app_bloc.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.BaseAppBloc<_i5.AppEvent, _i5.AppState>>(
        () => _i5.AppBloc());
    gh.lazySingleton<_i5.AppBloc>(() => _i5.AppBloc());
    gh.lazySingleton<_i4.BaseClearUserDataUseCase>(
        () => _i6.ClearUserDataUseCase());
    gh.lazySingleton<_i4.BaseExceptionHandler>(() => _i7.ExceptionHandler());
    gh.lazySingleton<_i4.BaseExceptionMapper>(() => _i8.ExceptionMapper());
    gh.lazySingleton<_i4.BasePopupInfoMapper>(() => _i9.AppPopupInfoMapper());
    gh.lazySingleton<_i4.BaseRouteInfoMapper>(() => _i10.AppRouteInfoMapper());
    gh.lazySingleton<_i11.HomeBloc>(() => _i11.HomeBloc());
    gh.lazySingleton<_i4.BaseNavigator>(() => _i12.Navigator(
          gh<_i3.AppRouter>(),
          gh<_i4.BasePopupInfoMapper>(),
          gh<_i4.BaseRouteInfoMapper>(),
        ));
    return this;
  }
}
